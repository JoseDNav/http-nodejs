...
app.get('/api/docente_identidad/:identidad', (req, res) => {
    let con = mysql.createConnection({
        host: "sql10.freesqldatabase.com",
        user: "sql10605673",
        password: "9KMvthvm28",
...
app.post('/api/administrador/', (req, res) => {
    ...
    let sql = "insert into tabla_administrador" +
        "(id_administrador, nombre_admin, correo_admin, pass_admin, active)" +
        "values (?,?,?,?,?)";
    let parametros = [req.body.id_administrador, req.body.nombre_admin, req.body.correo_admin, req.body.pass_admin, req.body.active];
...
app.put('/api/administrador/:id', (req, res) => {
    ...
    let sql = "update tabla_administrador set  nombre_admin = ?, correo_admin = ?, pass_admin = ?, active = ? where id_administrador = ?";
    let parametros = [req.body.nombre_admin, req.body.correo_admin, req.body.pass_admin, req.body.active, req.params.id];
...
app.put('/api/ticket/:id_ticket', (req, res) => {
  ...
  //  let sql = "update tabla_ticket set  nombre_docente = ?, asunto = ?, descripcion = ?, fechaInicio = ?, fecha_Resolucion= ?, area= ?, grado= ?, estado=?, prioridad= ?, solucion= ? where id_ticket = ?";
  //  let parametros = [req.body.nombre_docente, req.body.asunto, req.body.descripcion, req.body.fechaInicio, req.body.fechaResolucion, req.body.area, req.body.grado, req.body.estado, req.body.prioridad, req.body.solucion, req.params.id_ticket];
